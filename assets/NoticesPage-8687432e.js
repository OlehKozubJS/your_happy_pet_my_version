import{v as n,x as D,j as e,i as g,r as d,N as Y,y as P}from"./index-cbe1880c.js";const{fonts:U}=D,G=n.form`
  margin-top: 40px;
  margin-inline: auto;
  margin-bottom: 43px;
  width: 608px;
...
`,q=n.button`
  ...
  border: none;
  background: none;
`,W=()=>e.jsxs(G,{children:[e.jsx(M,{type:"text",placeholder:"Search"}),e.jsx(q,{type:"submit",children:e.jsx("svg",{width:"24",height:"24",viewBox:"0 0 24 24",fill:"none",children:e.jsx("use",{xlinkHref:`${g}#search`})})})]}),{fonts:T,fontSizes:I,colors:E}=D,V=n.form`
  display: flex;
  flex-wrap: wrap;
  gap: 12px;
`,B=n.input`
...
`,ae=n.label`
  ...
  column-gap: 12px;
  font-size: 12px;
`,m=({name:i,value:c,checked:t,children:o})=>e.jsxs(ae,{children:[e.jsx(ne,{type:"radio",name:i,value:c}),e.jsx("svg",{width:"24",height:"24",viewBox:"0 0 24 24",fill:"none",children:e.jsx("use",{xlinkHref:`${g}#${t?"check-round":"round"}`})}),o]}),ie=({onClick:i,onChange:c,initialValue:t})=>{const[o,s]=d.useState(t),p=r=>{r.preventDefault();const h=r.currentTarget.elements.ageOption.value;s(h),c(h)},f=r=>{r.preventDefault(),i()};return e.jsxs(L,{onInput:p,onSubmit:f,children:[e.jsxs(w,{type:"submit",children:[e.jsx("svg",{width:"24",height:"24",viewBox:"0 0 24 24",fill:"none",children:e.jsx("use",{xlinkHref:`${g}#chevron-up`})}),"By age"]}),e.jsx(m,{name:"ageOption",value:"upToOne",checked:o==="upToOne",children:"up to 1 year"}),e.jsx(m,{name:"ageOption",value:"upToTwo",checked:o==="upToTwo",children:"up to 2 years"}),e.jsx(m,{name:"ageOption",value:"fromTwo",checked:o==="fromTwo",children:"from 2 years"}),e.jsx(m,{name:"ageOption",value:"anyAge",checked:o==="anyAge",children:"any age"})]})},se=({onClick:i,onChange:c,initialValue:t})=>{const[o,s]=d.useState(t),p=r=>{r.preventDefault();const h=r.currentTarget.elements.genderOption.value;s(h),c(h)},f=r=>{r.preventDefault(),i()};return e.jsxs(L,{onInput:p,onSubmit:f,children:[e.jsxs(w,{type:"submit",children:[e.jsx("svg",{width:"24",height:"24",viewBox:"0 0 24 24",fill:"none",children:e.jsx("use",{xlinkHref:`${g}#chevron-up`})}),"By gender"]}),e.jsx(m,{name:"genderOption",value:"female",checked:o==="female",children:"female"}),e.jsx(m,{name:"genderOption",value:"male",checked:o==="male",children:"male"}),e.jsx(m,{name:"genderOption",value:"",checked:o==="",children:"any gender"})]})},re=({onChange:i})=>{const[c,t]=d.useState(!1),[o,s]=d.useState(!1),[p,f]=d.useState(!1),[r,h]=d.useState("anyAge"),[v,b]=d.useState(""),[S,j]=d.useState(!1),$=()=>{j(!0)},F=()=>{j(!1)},a=()=>{t(!c)},u=()=>{s(!o)},l=()=>{f(!p)},x=C=>{h(C)},k=C=>{b(C)};return d.useEffect(()=>{i({age:r,gender:v})},[r,v]),c?e.jsxs(X,{children:[e.jsxs(oe,{onClick:a,children:[e.jsx("svg",{width:"24",height:"24",viewBox:"0 0 24 24",fill:"none",children:e.jsx("use",{xlinkHref:`${g}#chevron-up`})}),"Filters"]}),e.jsxs(ee,{children:[o?e.jsx(ie,{onClick:u,onChange:x,initialValue:r}):e.jsxs(w,{onClick:u,children:[e.jsx("svg",{width:"24",height:"24",viewBox:"0 0 24 24",fill:"none",children:e.jsx("use",{xlinkHref:`${g}#chevron-down`})}),"By gender"]}),p?e.jsx(se,{onClick:l,onChange:k,initialValue:v}):e.jsxs(w,{onClick:l,children:[e.jsx("svg",{width:"24",height:"24",viewBox:"0 0 24 24",fill:"none",children:e.jsx("use",{xlinkHref:`${g}#chevron-down`})}),"By gender"]})]})]}):e.jsxs(te,{onClick:a,onMouseOver:$,onMouseLeave:F,children:["Filter",e.jsx("svg",{width:"24",height:"24",viewBox:"0 0 24 24",stroke:S?"#FEF9F9":"#54adff",children:e.jsx("use",{xlinkHref:`${g}#filters-3`})})]})},{fonts:A,fontSizes:le,fontWeights:R,colors:de}=D,ce=n.h3`
  margin-top: 90px;
  color: #111;
