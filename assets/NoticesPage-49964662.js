import{v as o,x as D,j as e,i as u,r as l,N as Y,y as P}from"./index-16f024db.js";const{fonts:U}=D,G=o.form`
  margin-top: 40px;
  margin-inline: auto;
  margin-bottom: 43px;
  width: 608px;
...
`,q=o.button`
  ...
  border: none;
  background: none;
`,W=()=>e.jsxs(G,{children:[e.jsx(M,{type:"text",placeholder:"Search"}),e.jsx(q,{type:"submit",children:e.jsx("svg",{width:"24",height:"24",viewBox:"0 0 24 24",fill:"none",children:e.jsx("use",{xlinkHref:`${u}#search`})})})]}),{fonts:T,fontSizes:I,colors:E}=D,K=o.form`
  display: flex;
  column-gap: 12px;
  height: 35px;
`,B=o.input`
