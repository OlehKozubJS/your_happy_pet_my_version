...
`;function Ft({pets:e,onDelete:a}){return t.jsxs("div",{style:{position:"relative",zIndex:5},children:[t.jsxs(Dt,{to:"/add-pet",children:[t.jsx(jt,{style:{stroke:"#fff"}}),t.jsx("span",{children:"Add pet"})]}),e&&e.length>0?e.map(p=>t.jsx(Vt,{pet:p,onDelete:a},p._id)):t.jsx(Bt,{children:"You didnt added any pets!"})]})}const Pt=i.div`
  margin-left: auto;
  margin-right: auto;
  width: 320px;
  padding-top: 40px;
...
`,Ot=i.div`
  ...
  position: absolute;
  z-index:10
`;function qt(){const[e,a]=n.useState(!1),[p,l]=n.useState(!1),[k,E]=n.useState(""),[M,S]=n.useState(""),[b,V]=n.useState(""),[D,B]=n.useState(""),[F,P]=n.useState(""),[C,j]=n.useState(null),[R,y]=n.useState(null),[A,U]=n.useState(null),[$,H]=n.useState(null),[g,v]=n.useState(null),{profilePic:z}=Z(),{isLoading:T}=Z(),O=pt(),c=lt(o=>o.auth.token),m="No info",I=o=>{o.preventDefault(),a(!e)},K=o=>{E(o.target.value)},X=o=>{S(o.target.value)},Y=o=>{const d=o.target.value.replace(/[^\d()\-]/g,"");B(d)},q=o=>{P(o.target.value)},G=async o=>{o.preventDefault();const r=new FormData;r.append("username",k),r.append("email",M),r.append("birthDay",b),r.append("phone",D),r.append("city",F),C&&r.append("image",R),O(mt({token:c,editedUserFormData:r})),j(null),y(null),a(!1),l(!1)},J=o=>{o.preventDefault(),l(!0)},Q=o=>{o.preventDefault(),j(null),y(null),l(!1)},tt=async o=>{try{const r=await L.delete(`${{}.VITE_BACKEND_BASE_URL}/api/myPet/${o}`,{headers:{Authorization:`Bearer ${c}`}});H(d=>d.filter(s=>s._id!==o))}catch(r){console.error("Error:",r)}};n.useEffect(()=>{U(z)},[z]),n.useEffect(()=>{const o=async()=>{try{const s=await L.get(`${{}.VITE_BACKEND_BASE_URL}/api/myPet`,{headers:{"Content-Type":"multipart/form-data",Authorization:`Bearer ${c}`}});H(s.data.data.response.docs)}catch(s){return console.error("Error fetching user:",s),null}},r=async()=>{try{return(await L.get(`${{}.VITE_BACKEND_BASE_URL}/api/auth/current`,{headers:{"Content-Type":"multipart/form-data",Authorization:`Bearer ${c}`}})).data}catch(s){return console.error("Error fetching user:",s),null}};(async()=>{const s=await r();if(s){const{username:nt,email:it,birthDay:ot,phone:rt,city:st,profilePic:at}=s;E(nt||m),S(it||m),B(rt||m),P(st||m),U(at||""),V(ot||"")}})(),o()},[c]);const et=o=>{const r=o.target.files[0];if(r){const d=URL.createObjectURL(r);j(d),y(r)}};return t.jsx(t.Fragment,{children:t.jsxs(Pt,{children:[t.jsxs(W,{children:[t.jsx(_,{children:"My information:"}),t.jsxs(At,{children:[T&&t.jsx(Ot,{children:t.jsx(ct,{})}),t.jsxs(Ut,{children:[A?t.jsx(Rt,{src:A,alt:"User picture"}):t.jsx(vt,{}),e&&(p?t.jsxs("div",{style:{display:"flex",alignItems:"center",justifyContent:"center",gap:"8px",position:"absolute",bottom:"-36px",left:"20px"},children:[t.jsx(_t,{children:C?t.jsx("img",{src:C,alt:"Selected",style:{width:"100%",height:"100%",borderRadius:"25px"}}):t.jsxs(t.Fragment,{children:[t.jsx(Nt,{width:"24",height:"24",children:t.jsx("use",{href:xt+"#plus",fill:"white"})}),t.jsx($t,{type:"file",onChange:et,name:"image"})]})}),t.jsxs(Wt,{onClick:Q,children:["Cancel photo ",t.jsx(Lt,{})]})]}):t.jsxs(Zt,{onClick:J,type:"button",children:[t.jsx(ft,{}),t.jsx("span",{children:"Edit photo"})]}))]}),t.jsxs(Ht,{children:[t.jsxs(x,{children:[t.jsx(h,{children:"Name:"}),t.jsx(w,{type:"text",name:"name",value:k,disabled:!e,onChange:K})]}),t.jsxs(x,{children:[t.jsx(h,{children:"Email:"}),t.jsx(w,{type:"email",name:"email",value:M,disabled:!e,onChange:X})]}),t.jsxs(x,{children:[t.jsx(h,{children:"Birthday:"}),t.jsx(Tt,{type:"text",name:"birthday",selected:b?new Date(b):null,disabled:!e,onChange:o=>V(o||"")})]}),t.jsxs(x,{children:[t.jsx(h,{children:"Phone:"}),t.jsx(w,{type:"text",name:"phone",value:D,disabled:!e,onChange:Y})]}),t.jsxs(x,{children:[t.jsx(h,{children:"City:"}),t.jsx(w,{type:"text",name:"city",value:F,disabled:!e,onChange:q})]})]}),e?t.jsx(It,{onClick:G,children:"Save"}):t.jsxs(zt,{type:"button",onClick:()=>v(!g),children:[t.jsx(Ct,{style:{stroke:"#54ADFF",marginRight:"12px"}})," ","Log Out"]}),e?t.jsx(N,{onClick:I,children:t.jsx(wt,{style:{stroke:"#54ADFF"}})}):t.jsx(N,{onClick:I,children:t.jsx(bt,{style:{stroke:"#54ADFF"}})})]})]}),t.jsxs(W,{children:[t.jsx(_,{children:"My pets:"}),t.jsx(Ft,{pets:$,onDelete:tt})]}),g&&t.jsx(ht,{closeModal:()=>v(!g),children:t.jsx(gt,{closeModal:()=>v(!g)})})]})})}export{qt as default};
